...
<head>
    ...
    <script src="<c:url value="/js/needleCheck.js"/> "></script>
</head>
<body>
<div id="wrapper">
    ...
    <div id='page-wrapper'>
        <div class="row" id="needleCardReleasePage">
            <div class="col-lg-12">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form role="form" id="needleCardCheckForm">
                            ...
                            <div class="form-group">
                                ...
                                <p class="col-lg-4">
                                    ...
                                    <input class="form-control" name="pteOperator" id="pteOperator" style="width: 40%" type="text">
                                </p>
                                <p class="col-lg-4">
                                    <label class="col-lg-2">良率</label>
                                    <input class="form-control" name="cardYield" id="cardYield" style="width: 40%" type="text">%
                                </p>
                            </div>
                            <div class="form-group">
                                <p class="col-lg-4">
                                    <label class="col-lg-4">针痕验收</label>
                                    <input class="form-control" name="cardOperator" id="cardOperator" style="width: 35%" type="text">
                                </p>
                                <p class="col-lg-4">
                                    <label class="col-lg-3">针痕</label>
                                    <select  class="form-control" name="pinMarks"  id="pinMarks" style="width: 35%">

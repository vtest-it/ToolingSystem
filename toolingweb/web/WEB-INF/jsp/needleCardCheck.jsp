                ...
                <div class="panel-body">
                    <div class="row">
                        <form role="form" id="needleCardCheckForm">
                            ...
                            <div class="form-group">
                                <p class="col-lg-6">
                                    <label class="col-lg-3">工程验收</label>
                                    <input class="form-control" name="pteOperator" id="pteOperator" style="width: 45%" type="text">
                                </p>
                                <p class="col-lg-6">
                                    <label class="col-lg-2">良率</label>
                                    <input class="form-control" name="cardYield" id="cardYield" style="width: 45%" type="text">%
                                </p>
                            </div>
                            <div class="form-group">
                                <p class="col-lg-4">

                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" id="needleCardLendForm">
                                ...
                                <div class="form-group">
                                    <p class="col-lg-6">
                                        <label class="col-lg-3">借出机台</label>
                                        <input class="form-control" name="outuseEquipment" id="outuseEquipment" style="width: 45%" type="text">
                                    </p>
                                    ...
                                    <p class="col-lg-6">
                                        <label class="col-lg-3">借出人员</label>
                                        <input class="form-control" name="outOperator" id="outOperator" style="width: 45%" type="text">
                                    </p>
                                ...
                                <div class="form-group">
                                    <p class="col-lg-4">
                                        ...
                                        <input class="form-control" name="operator" id="operator" style="width: 35%" type="text">
                                    </p>
                                    <p class="col-lg-4">
